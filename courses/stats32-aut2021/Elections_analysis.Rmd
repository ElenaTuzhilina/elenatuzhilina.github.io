...
R's default mapping data does not have FIPS county codes which we will need later in the analysis. As such, we use our own dataset:
```{r}
map_county_fips <- readRDS("county_map_fips.rds")
head(map_county_fips)
```

Next, we load the elections data.
```{r message=FALSE}
